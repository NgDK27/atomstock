...
class CrownIllustration extends GlassmorphismIllustration {
  const CrownIllustration({super.key, super.width = 236, super.height = 130});

  @override
  String getOverlaySvgPath() {
    return "M10.133 117.327.89 24.913C-.243 13.567 12.463 6.124 21.805 12.663l34.3 24.01a13.333 13.333 0 0 0 16.426-.888L109.22 3.683a13.333 13.333 0 0 1 17.56 0l36.689 32.102a13.333 13.333 0 0 0 16.426.889l34.3-24.01c9.342-6.54 22.048.903 20.914 12.249l-9.242 92.414a13.332 13.332 0 0 1-13.267 12.006H23.4c-6.85 0-12.586-5.19-13.267-12.006Z";
  }
