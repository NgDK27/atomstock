...
abstract class $MessageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? message, Sender sender});
}
...
class _$MessageModelImpl with DiagnosticableTreeMixin implements _MessageModel {
  const _$MessageModelImpl({required this.message, required this.sender});
...
abstract class _MessageModel implements MessageModel {
  const factory _MessageModel(
      ...
      required final Sender sender}) = _$MessageModelImpl;
