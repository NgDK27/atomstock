...
mixin _$PortfolioModel {
  ...
  List<StockPortfolioModel> get positions => throw _privateConstructorUsedError;
...
abstract class $PortfolioModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'positions') List<StockPortfolioModel> positions});
}
...
class _$PortfolioModelImpl implements _PortfolioModel {
  _$PortfolioModelImpl(
      ...
      @JsonKey(name: 'positions')
      required final List<StockPortfolioModel> positions})
  ...
  final List<StockPortfolioModel> _positions;
  @override
  @JsonKey(name: 'positions')
  List<StockPortfolioModel> get positions {
  ...
  @override
  String toString() {
    return 'PortfolioModel(totalValue: $totalValue, positions: $positions)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, totalValue, const DeepCollectionEquality().hash(_positions));
...
abstract class _PortfolioModel implements PortfolioModel {
  factory _PortfolioModel(
          {@JsonKey(name: 'totalValue') required final double totalValue,
          @JsonKey(name: 'positions')
          required final List<StockPortfolioModel> positions}) =
      _$PortfolioModelImpl;
