...
def md_get_intraday_OHLC():
	print(client.intraday_ohlc(config, model.intraday_ohlc('VPB', '11/07/2024', '11/07/2024', 1, 1000, True, 1)))
...
def md_get_stock_price():
	print(client.daily_stock_price(config, model.daily_stock_price ('DIG', '11/07/2024', '11/07/2024', 1, 100)))
